...
HabTable::HabTable(SensorTable* table, QObject *parent) : GenericTable(table, parent)
{
    ...
    table->setCellWidget(4, 0, new TableLabel("LoRa RSSI:"));
    ...
    table->setCellWidget(5, 2, new TableLabel("Velocity:"));
    table->setCellWidget(6, 2, new TableLabel("Velocity North:"));
    table->setCellWidget(7, 2, new TableLabel("Velocity East:"));
    table->setCellWidget(8, 2, new TableLabel("Velocity Down:"));
...
void HabTable::update_table(SensorData* sens, GpsData* gps, StatusData* status)
{
    char value_str[64];
    ...
    sprintf_s(value_str, "%.2f dBm", status->rssi);
    ...
    sprintf_s(value_str, "%.2f m", gps->height_msl);
